...
export default function CursorAgent() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#0f1117] via-[#181a20] to-[#1a1d23] px-4 sm:px-6 md:px-8 pb-24 pt-16">
      <div className="max-w-6xl w-full mx-auto">
        <Header />
      </div>

      <main className="flex-grow flex flex-col max-w-6xl mx-auto w-full px-0 sm:px-4 py-6 sm:py-8">

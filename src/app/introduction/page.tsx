    ...
    <PageLayout mainClassName="max-w-5xl">
      ...
      <div className="mb-12 text-center mt-8">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          Demystifying the magic behind ChatGPT and other generative AI systems
      ...
      <div className="bg-[#1c1f2a]/60 p-8 rounded-xl border border-[#353945] backdrop-blur-sm hover:shadow-red-500/5 hover:shadow-lg transition-all duration-300 mb-12">
        <h2 className="text-2xl font-semibold mb-4">The Impossible Question</h2>
        <p className="text-gray-300 mb-4">
          If I ask you a question you&apos;ve never seen before, would you be
          able to answer it? Most people initially think, &quot;No, that&apos;s
          impossible!&quot; But that&apos;s not quite true. You actually can
          answer new questions by recognizing patterns and applying your
          understanding from similar situations.
        </p>
        <p className="text-gray-300 mb-4">
          For example, if you know how addition works and I give you two numbers
          you&apos;ve never added before, you can still solve it by applying the
          pattern of addition. You don&apos;t need to have memorized every
          possible arithmetic problem to solve a new one.
        </p>
        <p className="text-gray-300">
          This is precisely how AI systems like ChatGPT work! They&apos;re not
          just retrieving memorized answers—they&apos;re recognizing patterns in
          language and generating responses based on those patterns, even to
          questions they&apos;ve never encountered. In this guide, we&apos;ll
          explore this fascinating capability using first principles and
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div className="bg-[#1c1f2a]/60 p-8 rounded-xl border border-[#353945] backdrop-blur-sm hover:shadow-red-500/5 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-gray-300">
            ...
            patterns in language and uses them to predict what text should come
            next.
          </p>
        </div>
        ...
        <div className="bg-[#1c1f2a]/60 p-8 rounded-xl border border-[#353945] backdrop-blur-sm hover:shadow-red-500/5 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-gray-300 mb-4">
            ...
            you?&quot;, it doesn&apos;t retrieve a pre-written answer. Instead,
            it predicts what text should follow your input, one token (piece of
            text) at a time.
          </p>
          <p className="text-gray-300">
            It recognizes that your greeting typically elicits responses like
            &quot;I&apos;m doing well, thank you for asking!&quot; based on
            patterns it learned during training - not because it was programmed
            with specific answers to specific questions.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 mt-3">
                ...
                GPT-3.5, and GPT-4 all use different tokenizers that split text
                in slightly different ways. This is why the same text might be
                broken into a different number of tokens depending on which
                model you&apos;re using.
              </p>
              <p className="text-gray-300 mt-3">
                A helpful rule of thumb is that one token generally corresponds
                to ~4 characters of English text, or roughly ¾ of a word (about
                100 tokens = 75 words).
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                The AI looks at your input tokens and predicts what should come
                next. For each position, it calculates probabilities for all
                possible next tokens. For example, after &quot;Hello, how
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                The model selects tokens based on these probabilities, adds them
                to the response, and then uses all text so far to predict the
                next token. This process repeats until a complete response is
                generated - creating new text that wasn&apos;t in its training
                data.
              </p>
            </div>
          </div>
      ...
      <div className="bg-[#1c1f2a]/30 rounded-xl border border-[#353945] p-8 mb-12">
        ...
        <p className="text-gray-300 mb-6">
          ...
          example of how the same text could be tokenized differently depending
          on the model:
        </p>
        ...
        <p className="text-gray-300 mt-4">
          ...
          important to understand when working with these systems, as it affects
          things like context length limits and processing costs.
        </p>
      </div>
      ...
      <div className="bg-[#1c1f2a]/30 rounded-xl border border-[#353945] p-8 mb-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-300">
            This works because the AI has learned patterns from millions of code
            examples - variable naming conventions, syntax rules, and common
            mistakes. It uses these patterns to recognize errors and predict the
            correct code, just like it predicts the next token in a
            conversation.
          </p>
        </div>
        ...
        <div className="mt-10 p-6 bg-[#13151b]/50 rounded-lg border border-[#353945]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-300">
            ...
            <li>
              It can handle questions it&apos;s never seen before by recognizing
              familiar patterns
            </li>
            <li>
